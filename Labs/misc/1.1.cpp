...
public:
  int num_people;
  string names[20]; //max car size is 5
  Time arrival;
  void print(){
    cout<<"The information for the new carpool: "<<endl;

    cout<<"The number of people: "<<num_people<<endl;
    ...
    cout<<"The arrival hour: "<<arrival.hour<<endl;
    cout<<"The arrival minute: "<<arrival.minute<<endl;
  }
};
